...
- Linux
- 教程
thumbnail: https://oss.keybrl.com/images/nginx-configure/nginx.jpg
---
...
![Nginx 的欢迎页面](https://oss.keybrl.com/images/nginx-configure/nginx_welcome_page.png)

而且无论你设置什么别的配置，80 端口都会被这个页面占用，所以需要先加个井号注释掉。

![Nginx 配置文件注释掉某行](https://oss.keybrl.com/images/nginx-configure/nginx_command.png)
