...
![CVM N线程加载N文件](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/cvm-N线程加载N文件.png)
...
![CDN N线程加载N文件](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/cdn-N线程加载N文件.png)

将两组测试平均值画在同一张图中

![N线程加载N文件](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/N线程加载N文件.png)
...
![OSS 多线程加载同一组资源](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/OSS-多线程加载同一组资源.png)
...
![OSS 多线程各自加载一组资源](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/OSS-多线程各自加载一组资源.png)
...
![CDN 多线程加载同一组资源](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/CDN-多线程加载同一组资源.png)

![CDN 多线程各自加载一组资源](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/CDN-多线程各自加载一组资源.png)

看起来好像和基准测试结果差不多。

将两组图表中的平均值放在一张图中比较一下

![多线程加载同一组资源 比较](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/both-多线程加载同一组资源.png)

![多线程各自加载一组资源 比较](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/both-多线程各自加载一组资源.png)
...
![oss定价](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/oss-price.png)
...
![cdn基础服务定价](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/cdn-base-price.png)
...
![cdn增值服务定价](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/cdn-extra-price.png)
...
![加载52KB的HTML文件](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/加载52KB的HTML文件.png)

![加载1386KB的图片文件](//keybrl-blog-assets.oss-cn-hangzhou.aliyuncs.com/images/do-you-need-cdn/加载1386KB的图片文件.png)
